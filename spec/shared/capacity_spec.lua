...
-- Verifies that InventoryContainer items receive correct capacity bonuses per rarity
...
ZBSpec.describe("capacity bonus edge cases", function()
    ...
    it("does not compound bonus on re-application", function()
        ...
        -- Re-apply same rarity (simulating save/load)
        apply_rarity(item, "Uncommon")
